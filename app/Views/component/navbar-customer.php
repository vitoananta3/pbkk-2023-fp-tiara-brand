  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 ">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-[#434C5E] dark:border-gray-700">
        ...
        <li>
          <a href="<?= base_url() ?>kategori" class="block py-2 px-3 text-[#E5E9F0] rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#81A1C1] md:p-0 dark:text-white md:dark:hover:text-[#81A1C1] dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent <?php echo $page === 'kategori' ? 'active-nav-item' : ''; ?>">Kategori</a>
        </li>
        <li>
        ...
        <li>
          <a href="<?= base_url() ?>keranjang" class="block py-2 px-3 text-[#E5E9F0] rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#81A1C1] md:p-0 dark:text-white md:dark:hover:text-[#81A1C1] dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent <?php echo $page === 'keranjang' ? 'active-nav-item' : ''; ?>">Keranjang</a>
        </li>
        <li>
          <a href="<?= base_url() ?>transaksi" class="block py-2 px-3 text-[#E5E9F0] rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#81A1C1] md:p-0 dark:text-white md:dark:hover:text-[#81A1C1] dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent <?php echo $page === 'transaksi' ? 'active-nav-item' : ''; ?>">Transaksi</a>
        </li>
      </ul>
    </div>
  </div>
